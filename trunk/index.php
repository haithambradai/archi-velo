...
<body>
	...
	<div class="container" style="margin-bottom:70px; text-align:center">
	    ...
	    <a href="index.php?ville=Toulouse"><button type="button" class="btn btn-warning" style="margin-right:35px; width: 150px;">Toulouse</button></a>
	    <a href="index.php?ville=Besancon"><button type="button" class="btn btn-success" style="width: 150px;">Besancon</button></a>	
	    <!-- Fin des villes -->
	</div>
				...
				<table class="table table-bordered">
					...
					<?php
						...
						for($i=0;$i<$nbLigne;$i++){
							...
							//Affichage des données avec les différents icones selon le nombre de vélos							
